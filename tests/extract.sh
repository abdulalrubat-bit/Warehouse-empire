...
EXPORT='  window.__sim = { GENS:GENS, UPGRADES:UPGRADES, PERKS:PERKS, CORP_BUILDINGS:CORP_BUILDINGS, costOf:costOf, totalRate:totalRate, grossRate:grossRate, wageBill:wageBill, activeRate:activeRate, networkRate:networkRate, tapValue:tapValue, prestigeMult:prestigeMult, repEarnedByLifetime:repEarnedByLifetime, pendingRep:pendingRep, fmt:fmt, THEMES:THEMES, OFFLINE_CAP_HOURS:OFFLINE_CAP_HOURS, MARKET:MARKET, marketOf:marketOf, marketMult:marketMult, mgrMult:mgrMult, SKUS:SKUS, invalidateUpMult:invalidateUpMult, upMult:upMult, RANKS:RANKS, rankIndex:rankIndex, SITES:SITES, siteUnlocked:siteUnlocked, skuUnlocked:skuUnlocked, INCIDENTS:INCIDENTS, clearIncident:clearIncident, TREE:TREE, TREE_BY_ID:TREE_BY_ID, hasNode:hasNode, buyNode:buyNode, repAvailable:repAvailable, heldDirectorship:heldDirectorship, nodeBlocked:nodeBlocked, netCap:netCap, netSiteRate:netSiteRate, netSetBonus:netSetBonus, netInvestCost:netInvestCost, netInvest:netInvest, netTypeCounts:netTypeCounts, treeOutput:treeOutput };'
